/*
 * Sinewave Generator with Manual DAC Driving
...
int main(void)
{
    ...
    while (1) {
        static const uint16_t wave[16]={2048,2831,3496,3939,4095,3939,3496,2831,2048,1265,600,157,0,157,600,1265};
        for(uint32_t i=0;i<16;i++){HAL_DAC_SetValue(&hdac,DAC_CHANNEL_1,DAC_ALIGN_12B_R,wave[i]); for(volatile uint32_t d=0;d<900;d++){} }
    }
}
