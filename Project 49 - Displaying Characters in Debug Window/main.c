/*
 * Displaying Characters in Debug Window
...
int main(void){HAL_Init();SystemClock_Config();while(1){const char*s="F446RE SWV\r\n";while(*s)itm_putchar(*s++);HAL_Delay(1000);}}