/*
 * 4-Digit 7-Segment LED Up Counter with Timer Interrupts
...
/*
 * The display refresh is short and non-blocking enough for this portfolio
 * example. In a stricter implementation, move one digit refresh step into
 * a TIM interrupt callback generated by CubeMX.
 */
int main(void)
{
