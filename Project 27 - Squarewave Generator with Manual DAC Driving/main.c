/*
 * Squarewave Generator with Manual DAC Driving
...
int main(void)
{
    ...
    while (1) {
        HAL_DAC_SetValue(&hdac,DAC_CHANNEL_1,DAC_ALIGN_12B_R,4095); HAL_Delay(1);
        HAL_DAC_SetValue(&hdac,DAC_CHANNEL_1,DAC_ALIGN_12B_R,0); HAL_Delay(1);
    }
}
