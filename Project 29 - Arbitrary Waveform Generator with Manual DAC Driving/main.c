/*
 * Arbitrary Waveform Generator with Manual DAC Driving
...
int main(void)
{
    ...
    while (1) {
        static const uint16_t wave[8]={0,400,1000,2800,4095,3000,1600,500};
        for(uint32_t i=0;i<8;i++){HAL_DAC_SetValue(&hdac,DAC_CHANNEL_1,DAC_ALIGN_12B_R,wave[i]); HAL_Delay(1);}
    }
}
