/*
 * Communicating with Arduino - Displaying Temperature
...
int main(void)
{
    ...
    while (1) {
        uint8_t c; if(HAL_UART_Receive(&huart2,&c,1,HAL_MAX_DELAY)==HAL_OK) HAL_UART_Transmit(&huart2,&c,1,HAL_MAX_DELAY);
    }
}
